...
extern uint8_t* hacker_manifesto_borg_txt_hfm PROGMEM;
extern uint8_t* test_txt_hfm PROGMEM;
//extern void* COPYING_gpl3_hfm;
...
void decompress_test(void){
	decompress(&test_txt_hfm);
}

void decompress_hacker(void){
	decompress(hacker_manifesto_borg_txt_hfm);
}
/*
void decompress_GPL(void){
	decompress(COPYING_gpl3_hfm);
}
*/
/******************************************************************************/
